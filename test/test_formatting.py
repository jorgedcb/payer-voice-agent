...
from prompts.formatting import nato_spell, speak_code, speak_cpt_codes, speak_digits, speak_npi, speak_phone, speak_tax_id


@pytest.mark.parametrize("raw", ["+12025550123", "12025550123", "2025550123", "(202) 555-0123", "202-555-0123"])
def test_us_phone_numbers_read_in_three_groups(raw: str) -> None:
    ...
    assert speak_phone(raw) == "two, zero, two ... five, five, five ... zero, one, two, three"
...
def test_nato_spell_reads_every_letter_as_a_letter() -> None:
    ...
    assert nato_spell("Annie") == "A for alpha, N for november, N for november, I for india, E for echo"
...
def test_npi_reads_in_three_groups_with_commas() -> None:
    ...
    assert speak_npi("1234567893") == "one, two, three ... four, five, six ... seven, eight, nine, three"
...
def test_tax_id_reads_in_its_written_two_seven_shape() -> None:
    assert speak_tax_id("12-3456789") == "one, two ... three, four, five, six, seven, eight, nine"
...
def test_only_decimal_digits_are_spoken() -> None:
    ...
    assert speak_phone("² 2025550123") == "two, zero, two ... five, five, five ... zero, one, two, three"
