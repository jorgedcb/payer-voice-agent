...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "I'm still checking the information in my system.", id="computer-lookup"
        ),
        pytest.param(
            "I'm just entering the details. My computer is taking a little longer.",
            id="typing",
        ),
        pytest.param(
            "And the provider's network status is, let me see...",
            id="unfinished-speech",
        ),
        pytest.param(
            "Please continue to hold. Your representative will be with you shortly.",
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            "Are you still there?",
            "Briefly confirms that the caller is still on the line.",
            id="presence-check",
        ),
        pytest.param(
            "I'm still checking, but can you confirm the member ID?",
