...
async def test_assistant_greeting(session, start_assistant, llm) -> None:
    ...
    result = await session.run(user_input="Good afternoon. Thank you for calling ATMA. This is Alice I'll be your customer advocate for today. How may I help you?")
